...
export class BlogController {
  ...
  async createBlog(@Body() createBlogDto: CreateBlogDto, @UserEmail() userEmail: string) {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ description: 'Get a blog by its ID.', summary: 'Get Blog by ID.' })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ description: 'Get blogs by title.', summary: 'Get Blog by Title.' })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ description: 'Get blogs by author username.', summary: 'Get Blog by Author.' })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ description: 'Get blogs by user ID.', summary: 'Get Blog by User ID.' })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ description: 'Get blogs by genre.', summary: 'Get Blog by Genre.' })
