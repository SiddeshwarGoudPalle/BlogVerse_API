...
export class AuthController {
  ...
  updateEmail(@UserEmail() userEmail: string, @Body() updateEmailDto: UpdateEmailDto) {
  ...
  @ApiOperation({ description: 'Update username.', summary: 'Update Username.' })
  updateUsername(@UserEmail() userEmail: string, @Body() updateUsernameDto: UpdateUsernameDto) {
